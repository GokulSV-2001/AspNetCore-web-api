...
namespace NZwalks.Api.Controllers
{
    ...
    public class WalksController : ControllerBase
    {
        ...
        [HttpGet]
        //Filtering
        //api/Walks?filterOn=Name&FilterQuery=londo&sortBy=Name&sortOn=true
        public async Task<ActionResult<List<WalkDto>>> GetAllWalks([FromQuery] string? filterOn,string? filterQuery,string? sortBy,bool? ascending,
        int pageNumber=1,int pageSize=1000)
        {
          var walk= await  repository.GetAllWalksAsync(filterOn,filterQuery,sortBy,ascending ?? true,pageNumber,pageSize);
          //map model to DTO
